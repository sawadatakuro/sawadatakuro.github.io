/* ============================================================
   ...
   ● 作品ページは story[] を上から順に表示します。
     - 文章ブロック  { type:"text",  headingEn, headingJa, en:[...], ja:[...] }
     - 写真1枚(大)  { type:"image", src, capEn, capJa }
     - 写真2枚(並び){ type:"pair",  items:[ {src,capEn,capJa}, {src,capEn,capJa} ] }
     順番を入れ替えたい → ブロックごと上下に移動
     写真を差し込みたい → 好きな位置に image / pair ブロックを1つ足す
     文章を直したい     → 該当の "..." の中を書き換える
...
const WORKS = [
  {
    ...
    story: [
      ...
      { type:"image", src:"images/fluid-vessel/13-living-panorama.jpg",
        capEn:"The 65-square-metre interior, read as a single vessel.",
        capJa:"65㎡の内部を、ひとつの器として読む。" },
      ...
      { type:"image", src:"images/fluid-vessel/03-living-wide.jpg",
        capEn:"Partitions removed, life opens across the full width of the river-facing frontage.",
        capJa:"間仕切りを取り払い、川に面する間口の全幅に暮らしを開く。" },

      { type:"text", headingEn:"Perpendicular to a found order", headingJa:"発見された構造に、直交する",
        en:[
      ...
      { type:"pair", items:[
        { src:"images/fluid-vessel/08-partition.jpg",
          capEn:"All partitions run perpendicular to the beams' river-parallel grain.",
          capJa:"すべての建具は、川と平行な梁に直交して走る。" },
        { src:"images/fluid-vessel/06-fusuma-open.jpg",
          capEn:"Slide the panels back, and the three zones become one.",
          capJa:"戸襖を引けば、三つの領域はひとつの場になる。" }
      ]},

      { type:"text", headingEn:"Close it, and it becomes a room", headingJa:"閉じれば部屋になる",
        en:[
      ...
      { type:"image", src:"images/fluid-vessel/05-fusuma-closed.jpg",
        capEn:"One panel — a divider, a screen for storage, a child's hiding place.",
        capJa:"同じ一枚が、仕切りにも、収納の目隠しにも、子どもの隠れ家にもなる。" },

      { type:"pair", items:[
        { src:"images/fluid-vessel/09-kitchen.jpg",
          capEn:"A circulation loop turns around the large-format stone island.",
          capJa:"大判天然石の島を、回遊動線が巡る。" },
        { src:"images/fluid-vessel/11-washbasin.jpg",
          capEn:"An open washbasin along the circulation loop.",
          capJa:"回遊動線の傍らのアウトベーシン。" }
      ]},

      { type:"text", headingEn:"The warmth of the hand against a cold city", headingJa:"都市の冷たさに、手の温度を",
        en:[
      ...
      { type:"image", src:"images/fluid-vessel/01-entrance.jpg",
        capEn:"Hand-trowelled stucco antico — the warmth of the hand against a cold city.",
        capJa:"手で塗り重ねたスタッコアンティコ。都市の冷たさに、手の温度を返す。" },

      { type:"pair", items:[
        { src:"images/fluid-vessel/02-living-vault.jpg",
          capEn:"The river embankment's section, reversed overhead. Light without downlights.",
          capJa:"護岸の断面を反転して頭上に。ダウンライトを使わない光。" },
        { src:"images/fluid-vessel/14-night-halo.jpg",
          capEn:"At night, indirect light spreads along the curve. The light is never fixed.",
          capJa:"夜、間接光がアールに沿って広がる。光は固定されない。" }
      ]},

      { type:"text", headingEn:"A destination I arrived at", headingJa:"たどり着いた場所",
        en:[
      ...
      { type:"image", src:"images/fluid-vessel/04-dining.jpg",
        capEn:"One vessel, furnished for a family of three.",
        capJa:"三人家族のための、ひとつの器。" },

      { type:"pair", items:[
        { src:"images/fluid-vessel/07-study.jpg",
          capEn:"A workspace tucked into the frontage, framed by the same panels.",
          capJa:"戸襖に縁取られ、間口の一角に収めた仕事の場。" },
        { src:"images/fluid-vessel/10-kitchen-corridor.jpg",
          capEn:"Behind the stone island, the concrete skeleton left legible.",
          capJa:"石の島の裏手に、躯体の表情をそのまま残す。" }
      ]}
    ],

    planImage: "images/fluid-vessel/15-plan.jpg",
    planCaptionEn: "Every intervention set perpendicular to the existing structure, which runs parallel to the river.",
